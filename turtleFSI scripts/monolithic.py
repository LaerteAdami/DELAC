...
# LA: keep times
T_control = default_variables["T_control"]
T = default_variables["T"]
train_agent = default_variables["train_agent"]
...
# LA: keep times
default_variables.update({"T_control":T_control, "T":T})
...
T_new = default_variables["T_control"]
T = default_variables["T"]
vars().update(initiate(T_new, T))
...
if restart_folder is not None and train_agent is None:
